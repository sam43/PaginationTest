package com.example.looser43.paginationtest.adapter;
...
import com.example.looser43.paginationtest.R;
...
public class PaginationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<DataItem> movieResults;
    ...
    public List<DataItem> getMovies() {
        return movieResults;
    }

    public void setMovies(List<DataItem> movieResults) {
...
/*            case HERO:
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        DataItem result = movieResults.get(position); // Movie
...
*/
            ...
            case ITEM:
                ...
                movieVH.mMovieTitle.setText(result.getName());
                //movieVH.mYear.setText(formatYearLabel(result));
                movieVH.mMovieDesc.setText(result.getType());
